...
{    
    const addToFavorites = `<svg width="14" height="12" viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    const AddToFavoritesSVG = () => <SvgXml xml={addToFavorites} />

    return <AddToFavoritesSVG />;
}
...
{    
    const addToFavoritesActive = `<svg width="27" height="24" viewBox="0 0 27 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    const AddToFavoritesActiveSVG = () => <SvgXml xml={addToFavoritesActive} />

    return <AddToFavoritesActiveSVG />;
}